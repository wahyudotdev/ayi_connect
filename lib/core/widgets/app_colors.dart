...
class AppColors {
  static const primary = Color(0xfd00CCCC);
  static const secondary = Color(0xffFA9D6B);
  static const textBlack = Color(0xFF030303);
  static const textGray = Color(0xff636366);
  static const softGray = Color(0xffCACACA);
